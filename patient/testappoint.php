...
<body>
<div class="container">
    <h5 class="mt-5 mb-3">Book Appointment</h5>
    <form id="appointmentForm" action="appointment_process.php" method="post">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div id="selectedSlotID" class="mt-2"></div>
            </div>
        </div>
        </div>
        <div class="row">
...
<script>
    ...
    function populateSlotGrid(slots) {
        ...
        slots.forEach(slot => {
            ...
            slotElement.addEventListener("click", () => {
                ...
                document.getElementById("selectedSlotID").textContent = "Selected Slot ID: " + slot.slotID;
    ...
    document.getElementById("doctorID").addEventListener("change", function() {
        ...
        fetch("create_appointment.php?doctorID=" + doctorID)
            .then(response => response.json())
            .then(data => {
