...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $doctorID = $_POST['doctorID']; // Added line to retrieve doctor ID from the form
    ...
    $currentDate = strtotime($availableDate);
    ...
    echo "<script>alert('Slots added successfully');window.location.replace('hospital_dashboard.php');</script>";
    exit();
} else {
