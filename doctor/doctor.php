            ...
            <div class="col-md-6 d-flex flex-column">
                <div class="card mb-0 h-100">
                    ...
                    <h3 class="card-title">National Electronic Medical Health Record</h3>
                        <p class="card-text">This is the Doctor Login page for the National Electronic Medical Health Record system. Please login with your credentials to access the doctor's features.</p>
